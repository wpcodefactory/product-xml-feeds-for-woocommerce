...
class Alg_WC_Product_XML_Feeds_Settings_General extends Alg_WC_Product_XML_Feeds_Settings_Section {
	 ...
	 * @todo    (dev) create all files at once (manually and synchronize update)?
	 */
	function get_settings() {
		return array(

			// Product XML Feeds Options
			array(
			...
			array(
				...
				'type'              => 'number',
				'desc'              => apply_filters(
					'alg_wc_product_xml_feeds_settings',
					sprintf(
			...
			array(
				...
				'desc_tip'          => (
					__( 'Sets PHP memory limit.', 'product-xml-feeds-for-woocommerce' ) . ' ' .
